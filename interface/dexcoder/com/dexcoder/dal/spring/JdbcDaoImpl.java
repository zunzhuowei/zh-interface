...
public class JdbcDaoImpl extends AbstractJdbcDaoImpl implements JdbcDao {
    ...
    public List<String[]> queryArrList(String refSql) {
		List<String[]> lists = jdbcTemplate.query(refSql,new RowMapper<String[]>(){
			@Override
			public String[] mapRow(ResultSet rs, int rownum) throws SQLException {
				int columnCount = rs.getMetaData().getColumnCount();
				String[] arrs = new String[columnCount];
				for (int i = 0; i < columnCount; i++) {
					arrs[i] = rs.getString(i+1);
				}
				return arrs;
			}				
		});
	...
	public List<String[]> queryArrList(String refSql, Object[] params) {
		List<String[]> lists = jdbcTemplate.query(refSql,params,new RowMapper<String[]>(){
			@Override
			public String[] mapRow(ResultSet rs, int rownum) throws SQLException {
				int columnCount = rs.getMetaData().getColumnCount();
				String[] arrs = new String[columnCount];
    ...
    public Object queryObjectForSql(String refSql) throws EmptyResultDataAccessException{
